...
function App() {
  ...
  return (
    <div className="page__container">
      ...
      <PopupWithForm title="Редактировать профиль" name="user" isOpen={isEditProfilePopupOpen} onClose={closeAllPopups} submitButtonText="Сохранить">
        <fieldset className="popup__fieldset" name="personal_info">
          <input id="name" className="popup__input popup__input_type_name" type="text" name="name" required minLength="2" maxLength="40" placeholder="Имя" />
          <span className="name-error error"></span>
          <input id="job" className="popup__input popup__input_type_job" type="text" name="about" required minLength="2" maxLength="200" placeholder="Занятие" />
          <span className="job-error error"></span>
        </fieldset>
      </PopupWithForm>

      <PopupWithForm title="Новое место" name="card" isOpen={isAddPlacePopupOpen} onClose={closeAllPopups} submitButtonText="Сохранить">
        <fieldset className="popup__fieldset" name="personal_info">
      ...
      <PopupWithForm title="Вы уверены?" name="delete" submitButtonText="Да" />
